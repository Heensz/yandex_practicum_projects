...
|2. |Оценка результатов А.В теста.|Оценка корректности проведения A/B-теста, анализ результатов A/B-теста, расчёт конверсии. |Python, pandas, datetime, numpy, matplotlib.pyplot, scipy.stats, graph_objects, math.|
